...
void DSPF_sp_fftSPxSP_r2c(int N, global float *ptr_x, global float *ptr_w, 
	global float *ptr_y, unsigned char *brev, int n_min, int offset, int n_max);
...
kernel void DSPF_sp_iirlat(global const float *x, int nx, 
	global const float *restrict k, int nk, global float *restrict b, 
	global float *restrict y)
{
